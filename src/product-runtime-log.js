...
export function safeLogDetails(value = {}) {
  ...
  if (['vector_jobs','vector_index','vector_staging'].includes(value?.storageArtifact)) result.storageArtifact=value.storageArtifact;
  return result;
}
