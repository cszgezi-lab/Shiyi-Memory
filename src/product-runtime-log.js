...
export function safeLogDetails(value = {}) {
  ...
  if (['summary','supplement','assistant','embedding','rerank','dynamicPersona'].includes(value?.modelRole)) result.modelRole = value.modelRole;
