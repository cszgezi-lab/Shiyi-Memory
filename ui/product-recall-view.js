...
export function recallSectionsHTML(){return `
  ...
  <section data-view="dictionary" hidden><h3>字典与标签</h3><details class="sy-card" open><summary>试试一句话会命中什么</summary><input data-dictionary-query aria-label="字典匹配测试" placeholder="输入人物别称或剧情关键词"><div data-dictionary-match class="sy-help" role="status"></div><p class="sy-help">本地匹配，不调用 API；命中人物不代表该人物在场或知情。</p></details>${dictionaryHTML()}<details class="sy-card"><summary>字典设置与高级文本</summary>${settingsSection('dictionary')}${button('save-settings','保存字典设置',true)}</details></section>
